      ...
      <body>
        <div class="sheet">
          ...
          <div class="meta">
            ...
            <div class="row"><b>Mode:</b><span>${e.training_mode || 'Offline'}</span></div>
          </div>
          ...
          <div class="footer">
            <p style="font-weight:700;color:#0f2c5b;">${b.name || 'ETI Educom Branch'}</p>
            <p style="font-size:8.5px;color:#4a5568;">
              ${[b.address, b.city, b.state, b.pincode].filter(Boolean).join(', ') || '—'}
            </p>
            <p style="font-size:8.5px;color:#4a5568;">
              ${b.branch_phone ? `Phone: ${b.branch_phone}` : ''}
