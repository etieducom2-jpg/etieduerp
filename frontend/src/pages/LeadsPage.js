...
const STATUS_COLORS = {
  'New': '#3B82F6',
  'Contact Attempted': '#60A5FA',
  'Connected': '#0EA5E9',
  'Contacted': '#8B5CF6',
  'Interested': '#A855F7',
  'Counselling Scheduled': '#6366F1',
  'Counselling Completed': '#4F46E5',
  'Parent Discussion Pending': '#F472B6',
  'Demo Booked': '#F59E0B',
  'Demo Scheduled': '#F59E0B',
  'Demo Attended': '#D97706',
  'Follow-up': '#06B6D4',
...
const STATUSES = [
  'New', 'Contact Attempted', 'Connected', 'Contacted', 'Interested',
  'Counselling Scheduled', 'Counselling Completed', 'Parent Discussion Pending',
  'Demo Booked', 'Demo Scheduled', 'Demo Attended', 'Follow-up',
  'Admission Likely', 'Converted', 'Admitted', 'Future Prospect',
  'Not Interested', 'Lost',
];
const VISIBLE_STATUSES = [
  'New', 'Contact Attempted', 'Connected', 'Contacted', 'Interested',
  'Counselling Scheduled', 'Counselling Completed', 'Parent Discussion Pending',
  'Demo Booked', 'Demo Scheduled', 'Demo Attended', 'Follow-up', 'Admission Likely',
];
...
const LeadsPage = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (['Admin', 'Branch Admin', 'Front Desk'].includes(user.role) && selectedCounsellor) {
